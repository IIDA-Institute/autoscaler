...
var multidimpodautoscalercheckpointsResource = schema.GroupVersionResource{Group: "autoscaling.k8s.io", Version: "v1alpha1", Resource: "multidimpodautoscalercheckpoints"}

var multidimpodautoscalercheckpointsKind = schema.GroupVersionKind{Group: "autoscaling.k8s.io", Version: "v1alpha1", Kind: "MultidimPodAutoscalerCheckpoint"}
...
func (c *FakeMultidimPodAutoscalerCheckpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MultidimPodAutoscalerCheckpoint, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(multidimpodautoscalercheckpointsResource, c.ns, name), &v1alpha1.MultidimPodAutoscalerCheckpoint{})
...
func (c *FakeMultidimPodAutoscalerCheckpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MultidimPodAutoscalerCheckpointList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(multidimpodautoscalercheckpointsResource, multidimpodautoscalercheckpointsKind, c.ns, opts), &v1alpha1.MultidimPodAutoscalerCheckpointList{})
...
func (c *FakeMultidimPodAutoscalerCheckpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(multidimpodautoscalercheckpointsResource, c.ns, opts))
...
func (c *FakeMultidimPodAutoscalerCheckpoints) Create(ctx context.Context, multidimPodAutoscalerCheckpoint *v1alpha1.MultidimPodAutoscalerCheckpoint, opts v1.CreateOptions) (result *v1alpha1.MultidimPodAutoscalerCheckpoint, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(multidimpodautoscalercheckpointsResource, c.ns, multidimPodAutoscalerCheckpoint), &v1alpha1.MultidimPodAutoscalerCheckpoint{})
...
func (c *FakeMultidimPodAutoscalerCheckpoints) Update(ctx context.Context, multidimPodAutoscalerCheckpoint *v1alpha1.MultidimPodAutoscalerCheckpoint, opts v1.UpdateOptions) (result *v1alpha1.MultidimPodAutoscalerCheckpoint, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(multidimpodautoscalercheckpointsResource, c.ns, multidimPodAutoscalerCheckpoint), &v1alpha1.MultidimPodAutoscalerCheckpoint{})
...
func (c *FakeMultidimPodAutoscalerCheckpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(multidimpodautoscalercheckpointsResource, c.ns, listOpts)
...
func (c *FakeMultidimPodAutoscalerCheckpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MultidimPodAutoscalerCheckpoint, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(multidimpodautoscalercheckpointsResource, c.ns, name, pt, data, subresources...), &v1alpha1.MultidimPodAutoscalerCheckpoint{})
